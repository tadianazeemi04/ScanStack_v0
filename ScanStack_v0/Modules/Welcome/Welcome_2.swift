                    ...
                    ZStack{
                        ...
                        ZStack{
                            /*Capsule()
                             .fill(
                             LinearGradient(
                             colors: [Color(hex: "2DBCFE").opacity(0.25), Color("btn_gradiant_color_1").opacity(0.19)], startPoint: .top, endPoint: .bottom
                             
                             )
                             )
                             .frame(width:246, height: 66)
                             .blur(radius: 8)
                             
                             Capsule()
                             .fill(
                             LinearGradient(
                             colors: [Color(hex: "2DBCFE").opacity(0.15), Color("btn_gradiant_color_1").opacity(0.09)], startPoint: .top, endPoint: .bottom
                             
                             )
                             )
                             .stroke(Color("btn_gradiant_color_0").opacity(0.8), lineWidth: 1.5)
                             .frame(width:246, height: 66)*/
                            
                            // 1. The Glass Core: This blurs the white background and gray text underneath
                            /*  Capsule()
                             .fill(.ultraThinMaterial) // 👈 This is what creates the true frosted glass look
                             .frame(width: 246, height: 66)
                             
                             // 2. The Tint Color Layer: Blends your custom gradient on top of the glass blur
                             Capsule()
                             .fill(
                             LinearGradient(
                             colors: [
                             Color(hex: "2DBCFE").opacity(0.15),
                             Color("btn_gradiant_color_1").opacity(0.15)
                             ],
                             startPoint: .top,
                             endPoint: .bottom
                             )
                             ...
                             // 3. The Specular Border: Gives the capsule a sharp, glass-like edge profile
                             Capsule()
                             .stroke(
                             LinearGradient(
                             colors: [
                             Color("btn_gradiant_color_0").opacity(0.8),
                             Color("btn_gradiant_color_1").opacity(0.4)
                             ],
                             startPoint: .top,
                             endPoint: .bottom
                             ),
